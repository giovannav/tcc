...
def build_model(input_shape, num_classes):
        ...
        model.add(tf.keras.layers.Conv2D(filters=32, kernel_size=(5,5), input_shape=input_shape, activation='relu', padding='same'))
...
def evaluate_model(model, history, test_data_gen, timestamp_start, num_epochs):
    ...
    model_name = f'NN2-{timestamp_start}-{timestamp}'
